 ...
 * @since	1.0
 **/
class ShapingRainFrameworkOptionDate extends ShapingRainFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		sr_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueDatepicker' ) );
		sr_add_action_once( 'customize_controls_enqueue_scripts', array( $this, 'enqueueDatepicker' ) );
	...
	public function enqueueDatepicker() {
		...
		wp_enqueue_script( 'tf-jquery-ui-timepicker-addon', ShapingRainFramework::getURL( '../js/min/jquery-ui-timepicker-addon-min.js', __FILE__ ), array( 'jquery-ui-datepicker', 'jquery-ui-slider' ) );
	}
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionDateControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionDateControl', 1 );
 ...
 * @since	1.3
 */
function registerShapingRainFrameworkOptionDateControl() {
	class ShapingRainFrameworkOptionDateControl extends WP_Customize_Control {
		public $description;
		public $date;
		public $time;
		...
		public function render_content() {
			...
			ShapingRainFrameworkOptionDate::createCalendarScript();
