 ...
 * @since	1.4
 **/
class ShapingRainFrameworkOptionSortable extends ShapingRainFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		sr_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueSortable' ) );
		sr_add_action_once( 'customize_controls_enqueue_scripts', array( $this, 'enqueueSortable' ) );
	}
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionSortableControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionSortableControl', 1 );
 ...
 * @since	1.4
 */
function registerShapingRainFrameworkOptionSortableControl() {
	class ShapingRainFrameworkOptionSortableControl extends WP_Customize_Control {
		public $description;
		public $options;
		public $visible_button;

		public function render_content() {
			ShapingRainFrameworkOptionSortable::createSortableScript();
