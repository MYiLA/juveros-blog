...
class ShapingRainFrameworkOptionMulticheck extends ShapingRainFrameworkOption {
	...
	public function display() {
		...
		if ( ! empty( $this->settings['select_all'] ) ) {
			...
			printf('<label style="margin-bottom: 1em !important;"><input class="sr_checkbox_selectall" type="checkbox" /> %s </label><br>',
	...
	public function load_select_scripts() {
		...
		wp_enqueue_script( 'tf-multicheck-select-all', ShapingRainFramework::getURL( '../js/multicheck-select-all.js', __FILE__ ), array( 'jquery' ), TF_VERSION, true );
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionMulticheckControl', 1 );
function registerShapingRainFrameworkOptionMulticheckControl() {
	class ShapingRainFrameworkOptionMulticheckControl extends WP_Customize_Control {
		public $description;
		public $options;
		public $select_all;
		...
		public function render_content() {
			...
			<label class='tf-multicheck-container'>
				...
				if ( ! empty( $this->select_all ) ) {
					...
					printf('<label style="margin-bottom: 1em !important; display: inline-block;"><input class="sr_checkbox_selectall" type="checkbox" /> %s </label><br>',
						esc_html( $select_all_label )
					);
				}
