...
class ShapingRainFrameworkOptionAjaxButton extends ShapingRainFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionAjaxButtonControl( $wp_customize, '', array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionAjaxButtonControl', 1 );
function registerShapingRainFrameworkOptionAjaxButtonControl() {
	class ShapingRainFrameworkOptionAjaxButtonControl extends WP_Customize_Control {
		public $description;
		public $options;

		public function render_content() {
			ShapingRainFrameworkOptionAjaxButton::createAjaxScript();
