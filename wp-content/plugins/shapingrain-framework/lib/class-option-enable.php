 ...
 */
class ShapingRainFrameworkOptionEnable extends ShapingRainFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionEnableControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionEnableControl', 1 );
function registerShapingRainFrameworkOptionEnableControl() {
	class ShapingRainFrameworkOptionEnableControl extends WP_Customize_Control {
		public $description;
		public $options;
