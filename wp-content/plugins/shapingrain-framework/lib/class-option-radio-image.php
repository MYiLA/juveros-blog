...
class ShapingRainFrameworkOptionRadioImage extends ShapingRainFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionRadioImageControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionRadioImageControl', 1 );
function registerShapingRainFrameworkOptionRadioImageControl() {
	class ShapingRainFrameworkOptionRadioImageControl extends WP_Customize_Control {
		public $description;
		public $is_font_icon;
