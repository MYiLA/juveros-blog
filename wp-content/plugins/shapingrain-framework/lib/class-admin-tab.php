...
class ShapingRainFrameworkAdminTab {
	...
	public function createOption( $settings ) {
		if ( ! apply_filters( 'sr_create_option_continue_' . $this->owner->owner->optionNamespace, true, $settings ) ) {
			return null;
		}
		...
		do_action( 'sr_create_option_' . $this->owner->owner->optionNamespace, $obj );
