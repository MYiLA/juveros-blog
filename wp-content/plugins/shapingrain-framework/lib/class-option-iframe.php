 ...
 * @since 1.0
 */
class ShapingRainFrameworkOptionIframe extends ShapingRainFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionIframeControl( $wp_customize, $this->getID(), array(
...
add_action( 'customize_register', 'register_shapingrain_framework_option_iframe_control', 1 );

/**
 * Register the customizer control
 */
function register_shapingrain_framework_option_iframe_control() {
	 ...
	 * @since 1.0
	 */
	class ShapingRainFrameworkOptionIframeControl extends WP_Customize_Control {
