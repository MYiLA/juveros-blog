 ...
 * @since	1.0
 **/
class ShapingRainFrameworkOptionNumber extends ShapingRainFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		sr_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueSlider' ) );
		sr_add_action_once( 'customize_controls_enqueue_scripts', array( $this, 'enqueueSlider' ) );
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionNumberControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionNumberControl', 1 );
 ...
 * @since	1.0
 */
function registerShapingRainFrameworkOptionNumberControl() {
	class ShapingRainFrameworkOptionNumberControl extends WP_Customize_Control {
		public $description;
		public $size;
		public $min;
		public $max;
		...
		public function render_content() {
			...
			if ( self::$firstLoad ) {
				ShapingRainFrameworkOptionNumber::createSliderScript();
			}
