...
class ShapingRainFrameworkOptionMulticheckPostTypes extends ShapingRainFrameworkOptionMulticheck {
	...
	public function display() {
		...
		// Fetch post types.
		$post_types = sr_get_post_types( $this->settings['public'], $this->settings['value'] );
