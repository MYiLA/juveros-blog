...
class ShapingRainFrameworkOptionTextarea extends ShapingRainFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionTextareaControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionTextareaControl', 1 );
function registerShapingRainFrameworkOptionTextareaControl() {
	class ShapingRainFrameworkOptionTextareaControl extends WP_Customize_Control {
		public $description;
		public $is_code;
