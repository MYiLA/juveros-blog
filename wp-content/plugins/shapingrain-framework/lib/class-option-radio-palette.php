...
class ShapingRainFrameworkOptionRadioPalette extends ShapingRainFrameworkOption {
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionRadioPaletteControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerShapingRainFrameworkOptionRadioPaletteControl', 1 );
function registerShapingRainFrameworkOptionRadioPaletteControl() {
	class ShapingRainFrameworkOptionRadioPaletteControl extends WP_Customize_Control {
		public $description;
