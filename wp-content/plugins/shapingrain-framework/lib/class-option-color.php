...
class ShapingRainFrameworkOptionColor extends ShapingRainFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		sr_add_action_once( 'admin_enqueue_scripts', array( $this, 'enqueueColorPickerScript' ) );
		sr_add_action_once( 'admin_footer', array( $this, 'startColorPicker' ) );
	}
	...
	public function enqueueColorPickerScript() {
		...
		wp_enqueue_script( 'wp-color-picker-alpha', ShapingRainFramework::getURL( '../js/min/wp-color-picker-alpha-min.js', __FILE__ ), array( 'wp-color-picker' ), TF_VERSION );
	}
	 ...
	 * @param ShapingRainFrameworkCustomizer $section
	 * @param int                      $priority The location/priority of this option inside the section.
	 *
	 * @return void
	 */
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new ShapingRainFrameworkOptionColorControl( $wp_customize, $this->getID(), array(
...
add_action( 'customize_register', 'registerShapingRainFrameworkOptionColorControl', 1 );


function registerShapingRainFrameworkOptionColorControl() {
	class ShapingRainFrameworkOptionColorControl extends WP_Customize_Color_Control {

		public $alpha;

		function __construct( $manager, $id, $args = array() ) {
			parent::__construct( $manager, $id, $args );
			sr_add_action_once( 'customize_controls_print_footer_scripts', array( $this, 'printOpacityOverrideTemplate' ) );
		}
