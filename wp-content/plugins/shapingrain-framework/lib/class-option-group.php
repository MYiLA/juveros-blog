...
class ShapingRainFrameworkOptionGroup extends ShapingRainFrameworkOption {
	 ...
	 * @param ShapingRainFrameworkAdminPage $owner The owner of the option.
	 */
		...
		if ( ! empty( $this->settings['options'] ) ) {
			...
			if ( is_array( $this->settings['options'] ) ) {
				...
				foreach ( $this->settings['options'] as $settings ) {
					...
					$obj = ShapingRainFrameworkOption::factory( $settings, $this->owner );
					$this->options[] = $obj;
