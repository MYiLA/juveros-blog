...
class shapingrainscssc {
	...
	protected $formatter = "shapingrainscss_formatter_nested";
	public function compile($code, $name=null) {
		...
		$this->parser = new shapingrainscss_parser($name);
	...
	protected function importFile($path, $out) {
		...
		if (isset($this->importCache[$realPath])) {
			...
			$parser = new shapingrainscss_parser($path, false);
...
class shapingrainscss_parser {
	...
	static protected function makeOperatorStr($operators) {
		return '('.implode('|', array_map(array('shapingrainscss_parser','preg_quote'),
			$operators)).')';
	}
	...
	protected function selectorSingle(&$out) {
		...
		while (true) {
			...
			// self
			if ($this->literal("&", false)) {
				$parts[] = shapingrainscssc::$selfSelector;
				continue;
			}
			if ($this->literal(".", false)) {
				$parts[] = ".";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class shapingrainscss_formatter {
	public $indentChar = "  ";
	public $break = "\n";
	public $open = " {";
	public $close = "}";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class shapingrainscss_formatter_nested extends shapingrainscss_formatter {
	public $close = " }";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class shapingrainscss_formatter_compressed extends shapingrainscss_formatter {
	public $open = "{";
	public $tagSeparator = ",";
	public $assignSeparator = ":";
	public $break = "";
