 ...
 *
 * @see     lib/class-shapingrain-framework.php
 */

/**
 * Plugin Name: ShapingRain Framework
 * Plugin URI: http://www.shapingrainframework.net/
 * Description: ShapingRain Framework is based on the Titan framework (http://gambit.ph) and provides backend features for ShapingRain themes.
 * Author: Benjamin Intal, Gambit, ShapingRain Labs
 * Version: 1.2.2
 * Author URI: https://shapingrain.com
 */
...
defined( 'TF_VERSION' ) or define( 'TF_VERSION', '1.2.1' );
// Used for text domains.
defined( 'TF_I18NDOMAIN' ) or define( 'TF_I18NDOMAIN', 'shapingrain-framework' );
// Used for general naming, e.g. nonces.
defined( 'TF' ) or define( 'TF', 'shapingrain-framework' );
// Used for general naming.
defined( 'TF_NAME' ) or define( 'TF_NAME', 'ShapingRain Framework' );
...
require_once( TF_PATH . 'lib/class-option-custom-template.php' );
...
require_once( TF_PATH . 'lib/class-shapingrain-css.php' );
require_once( TF_PATH . 'lib/class-shapingrain-framework.php' );
...
require_once( TF_PATH . 'lib/class-widget-import.php' );


/**
 * ShapingRain Framework Plugin Class
 *
 * @since 1.0
 */
class ShapingRainFrameworkPlugin {
	...
	public function trigger_option_creation() {
		 ...
		 * @since 1.0
		 */
		do_action( 'shapingrain_framework_create_options' );
		 ...
		 * @since 1.8
		 */
		do_action( 'shapingrain_framework_done' );
	}
	...
	public function plugin_links( $plugin_meta, $plugin_file ) {
		if ( TF_PLUGIN_BASENAME === $plugin_file ) {
			$plugin_meta[] = sprintf( "<a href='%s' target='_blank'>%s</a>",
				'https://www.shapingrain.com/support',
				__( 'Support', TF_I18NDOMAIN )
			);
		}
...
new ShapingRainFrameworkPlugin();
