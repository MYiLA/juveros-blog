<?php
/**
 * Template part for displaying single posts (gallery post format).
 *
				...
				<?php if ( aspen_show_categories() || aspen_show_date() || aspen_show_author() ) : ?>
					...
					<div class="blog-post-meta">
						<?php if ( aspen_show_author( true ) ) : ?>
							<span class="blog-post-author"><?php esc_html_e( 'Written by ', 'aspen' ); ?><?php the_author_posts_link(); ?></span>
						<?php endif; ?>
						<?php if ( aspen_show_categories( true ) ) : ?>
							<?php if ( aspen_categorized_blog() ) : ?>
								<span class="blog-post-category"><?php esc_html_e( 'in ', 'aspen' ); ?><?php the_category( ', ' ); ?></span>
							<?php endif; ?>
						<?php endif; ?>
					</div>
