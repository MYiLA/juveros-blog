	...
	<?php if ( get_post_format() == "link" ) : ?>
		...
		<div class="blog-post-link">
			<a href="<?php echo esc_url( aspen_post_meta( 'post_format_link_url' ) ); ?>" target="_blank">
				<?php the_post_thumbnail( 'aspen-post-thumbnail-split' ); ?>
				<div class="link"></div>
			</a>
		</div>
	...
	<?php elseif ( get_post_format() == "quote" ) : ?>
		...
		<?php if ( has_post_thumbnail() ) : ?>
			<div class="blog-post-image">
				<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'aspen-post-thumbnail-split' ); ?></a>
			</div>
		<?php endif; ?>
	...
	<?php elseif ( get_post_format() == "gallery" ) : ?>
		...
		if ( ! $images ) :
			if ( has_post_thumbnail() ) :
				the_post_thumbnail( 'aspen-post-thumbnail-split' );
			endif;
		else:
...
<div class="blog-post-summary-content col-2-3">
	...
	<?php if ( aspen_show_categories() ) : ?>
		<div class="blog-post-meta blog-post-meta-category">
			<?php if ( aspen_show_categories() ) : ?><?php if ( aspen_categorized_blog() ) : ?>
				<span class="blog-post-category"><?php the_category( ', ' ); ?></span><?php endif; ?><?php endif; ?>
		</div>
	<?php endif; ?>
	...
	<?php if ( aspen_show_date() || aspen_show_author() || aspen_show_comments_count() ) : ?>
		<div class="blog-post-meta">
			<?php if ( aspen_show_date() ) : ?><span class="blog-post-date">
